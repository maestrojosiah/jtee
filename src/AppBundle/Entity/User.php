...
class User implements AdvancedUserInterface, \Serializable
{
     ...
     * Add book
     *
     * @param \AppBundle\Entity\Product $book
     *
     * @return User
     */
    public function addProduct(\AppBundle\Entity\Product $book)
    {
        $this->books[] = $book;
     ...
     * @param \AppBundle\Entity\Product $book
     */
    public function removeProduct(\AppBundle\Entity\Product $book)
    {
     ...
     * @return User
     */
    public function addBook(\AppBundle\Entity\Product $book)
    {
        $this->books[] = $book;
     ...
     * @param \AppBundle\Entity\Product $book
     */
    public function removeBook(\AppBundle\Entity\Product $book)
    {
        $this->books->removeElement($book);
    }
